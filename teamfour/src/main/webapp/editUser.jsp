...
<%
	String userinfo = request.getParameter("user_id");
	UserInfoVO vo = null;
	try{
		vo = userInfoService.selectUser(userinfo);
...
%>
			...
			<form id="fregisterform" name="fregisterform"
				action="<%=request.getContextPath()%>/editUser_ok.jsp"
							...
							<tbody>
								<tr>
									...
									<td><input type="text" name="mb_id" id="uid" required
										class="reg_input" readonly="readonly" value="<%=userinfo%>">
								...
								<tr>
									...
									class="reg_input" readonly="readonly" value="<%=vo.getUser_pwd()%>">
										</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><input type="text" id="reg_mb_name" name="mb_name"
										readonly="readonly" value="<%=vo.getUser_name() %>" required class="reg_input"></td>
								</tr>
								<tr>
