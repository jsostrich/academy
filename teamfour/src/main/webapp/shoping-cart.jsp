						...
						<tbody>
							...
							<tr>
								...
								<td class="shoping__cart__item"><img class="session_data"
									src="<%=request.getContextPath() %>/img/<%=vo.getImage()%>" alt="">
									<h5 class="session_data"><%=vo.getPdName()%></h5></td>
								<td class="shoping__cart__price session_data"><%=vo.getPrice()%>
								</td>
								<td class="shoping__cart__quantity">
									<div class="quantity">
										<div class="pro-qty">
											<input type="text" value="<%=vo.getQty()%>"
												class="session_data">
										</div>
									</div>
								</td>
