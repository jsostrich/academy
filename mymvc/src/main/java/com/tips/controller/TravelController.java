...
public class TravelController extends HttpServlet {
	...
	/*
	 * <servlet> <servlet-name>travelController</servlet-name>
	 * <servlet-class>com.tips.controller.TravelController</servlet-class>
	 * </servlet> <servlet-mapping> <servlet-name>travelController</servlet-name>
	 * <url-pattern>/travel.do</url-pattern> </servlet-mapping>
	 * 
	 * <servlet> <servlet-name>bookController</servlet-name>
	 * <servlet-class>com.tips.controller.BookController</servlet-class> </servlet>
	 * <servlet-mapping> <servlet-name>bookController</servlet-name>
